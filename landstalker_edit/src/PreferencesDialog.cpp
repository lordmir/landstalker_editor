...
PreferencesDialog::PreferencesDialog(wxWindow* parent)
    : wxDialog(parent, wxID_ANY, "Preferences", wxDefaultPosition, wxSize(300, 600))
{
    ...
    m_ctrl_clone_in_new_dir = new wxCheckBox(this, wxID_ANY, "Clone when saving assembler to empty directory");
    ...
    m_ctrl_build_on_save = new wxCheckBox(this, wxID_ANY, "Build after saving assembler");
    ...
    gsizer->Add(m_ctrl_emulator, 1, wxALL | wxALIGN_CENTER_VERTICAL, 5);
    ...
    m_ok->Bind(wxEVT_BUTTON, &PreferencesDialog::OnCancel, this);
}
...
void PreferencesDialog::Commit()
{
    ...
    if (config != nullptr)
    {
        ...
        config->Write("/build/clonetag", m_ctrl_clonecmd->GetValue());
        config->Write("/build/cloneurl", m_ctrl_clonecmd->GetValue());
