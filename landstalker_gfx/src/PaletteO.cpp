...
const std::unordered_map<PaletteO::Type, std::array<bool, 16>> LOCKED_ENTRIES =
{
	{PaletteO::Type::NONE,        { true,  true,  true,  true,  true,  true,  true,  true,
								   true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::FULL,        {false, false, false, false, false, false, false, false,
								  false, false, false, false, false, false, false, false}},
	{PaletteO::Type::LOW8,        {false, false, false, false, false, false, false, false,
								   true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::ROOM,        { true,  true, false, false, false, false, false, false,
								  false, false, false, false, false, false, false,  true}},
	{PaletteO::Type::HUD,         { true,  true,  true,  true,  true,  true,  true,  true,
								   true,  true, false, false, false, false, false,  true}},
	{PaletteO::Type::SPRITE_LOW,  { true,  true, false, false, false, false, false, false,
								   true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::SPRITE_HIGH, { true,  true,  true,  true,  true,  true,  true,  true,
								  false, false, false, false, false, false, false,  true}},
	{PaletteO::Type::SPRITE_FULL, { true,  true, false, false, false, false, false, false,
								  false, false, false, false, false, false, false,  true}},
	{PaletteO::Type::PROJECTILE,  { true,  true,  true,  true,  true,  true,  true,  true,
								  false, false,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::SWORD,       { true,  true,  true,  true,  true,  true,  true,  true,
								   true,  true,  true,  true,  true, false, false,  true}},
	{PaletteO::Type::ARMOUR,      { true,  true,  true,  true,  true,  true,  true,  true,
								   true,  true,  true, false, false,  true,  true,  true}},
	{PaletteO::Type::LAVA,        { true,  true,  true,  true,  true,  true,  true,  true,
								  false, false,  true, false, false,  true,  true,  true}},
	{PaletteO::Type::WARP,        { true,  true,  true,  true,  true,  true,  true,  true,
								   true,  true,  true,  true,  true, false, false,  true}},
	{PaletteO::Type::SEGA_LOGO,   {false, false, false, false, false, false, false,  true,
								   true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::CLIMAX_LOGO, {false, false, false, false,  true,  true,  true,  true,
								   true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::TITLE_YELLOW,{ true, false, false, false, false, false,  true,  true,
								   true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::TITLE_SINGLE_COLOUR,{ true, false,  true,  true,  true,  true,  true,  true,
										  true,  true,  true,  true,  true,  true,  true,  true}},
	{PaletteO::Type::TITLE_BLUE_FADE, {false, false, false, false, false, false, false, false,
								      false, false, false, false, false, false, false, false}},
	{PaletteO::Type::END_CREDITS, {false, false, false, false,  true,  true,  true,  true,
								   true,  true,  true,  true,  true,  true,  true,  true}}
};
...
template <std::size_t N>
static void LoadPalette(const std::array<uint16_t, N>& palette, size_t begin, std::array<PaletteEntryO, 16> & outpal, bool var_width = false)
{
	size_t i = 0;
	...
	for (auto colour : palette)
	{
		...
		outpal[begin + i++] = PaletteO::FromGenesisColour(colour, (i + begin) == 0);
		if (i >= outpal.size())
		{
			break;
		}
...
PaletteO::PaletteO(const Rom& rom)
	: PaletteO()
{
	if (!m_cache_init)
	{
...
void PaletteO::AddHighPalette(const PaletteO& high_palette)
{
...
void PaletteO::RemoveHighPalette()
{
...
void PaletteO::AddLowPalette(const PaletteO& low_palette)
{
...
void PaletteO::RemoveLowPalette()
{
	if (m_type == Type::SPRITE_HIGH)
	{
		m_type = Type::SPRITE_FULL;
...
std::size_t PaletteO::GetPaletteCount(Type type) const
{
	switch (type)
	{
	case Type::ROOM:
...
PaletteO::PaletteO(const Rom& rom, std::size_t index, const Type& type)
    : PaletteO(rom)
{
	m_type = type;
    Load(index);
...
void PaletteO::Load(std::size_t index)
{
...
uint8_t PaletteO::getR(uint8_t index) const
{
    return m_pal[index].r;
}

uint8_t PaletteO::getG(uint8_t index) const
{
    return m_pal[index].g;
}

uint8_t PaletteO::getB(uint8_t index) const
{
    return m_pal[index].b;
}

uint8_t PaletteO::getA(uint8_t index) const
{
    return m_pal[index].a;
}

uint32_t PaletteO::getRGBA(uint8_t index) const
{
...
uint16_t PaletteO::getGenesisColour(uint8_t index) const
{
	return ToGenesisColour(m_pal[index]);
}

PaletteEntryO PaletteO::GetColour(uint8_t index) const
{
	return m_pal[index];
}

void PaletteO::setGenesisColour(uint8_t index, uint16_t colour)
{
	m_pal[index] = FromGenesisColour(colour);
}

bool PaletteO::ColourInRange(uint8_t colour) const
{
	return (colour < m_pal.size());
}

bool PaletteO::ColourEditable(uint8_t colour) const
{
...
const std::array<bool, 16>& PaletteO::GetLockedColours() const
{
	return LOCKED_ENTRIES.at(m_type);
}

PaletteEntryO PaletteO::FromGenesisColour(uint16_t colour, bool transparent)
{
	PaletteEntryO retval;
...
uint16_t PaletteO::ToGenesisColour(const PaletteEntryO& entry)
{
...
bool PaletteO::m_cache_init = false;
std::vector<std::array<uint16_t, 7>>  PaletteO::m_sprite_high_palettes;
std::vector<std::array<uint16_t, 6>>  PaletteO::m_sprite_low_palettes;
std::vector<std::array<uint16_t, 13>> PaletteO::m_room_palettes;
std::vector<std::array<uint16_t, 2>>  PaletteO::m_lava_palettes;
std::vector<std::array<uint16_t, 2>>  PaletteO::m_equipped_sword_palette;
std::vector<std::array<uint16_t, 2>>  PaletteO::m_equipped_armour_palette;
std::vector<std::array<uint16_t, 16>> PaletteO::m_full_palettes;
std::vector<std::array<uint16_t, 5>>  PaletteO::m_hud_palette;
std::vector<std::array<uint16_t, 8>>  PaletteO::m_inventory_palette_1_8col;
std::vector<std::array<uint16_t, 2>>  PaletteO::m_kazalt_warp_palette;
std::vector<std::array<uint16_t, 7>>  PaletteO::m_sega_logo_palette;
std::vector<std::array<uint16_t, 28>> PaletteO::m_title_seq_blue_palette;
std::vector<std::array<uint16_t, 5>>  PaletteO::m_title_seq_yellow_pallette;
std::vector<std::array<uint16_t, 1>>  PaletteO::m_title_seq_single_colours;
std::vector<std::array<uint16_t, 4>>  PaletteO::m_climax_logo_palette;
std::vector<std::array<uint16_t, 4>>  PaletteO::m_end_credits_palette;
std::vector<std::array<uint16_t, 2>>  PaletteO::m_projectiles_palette;
