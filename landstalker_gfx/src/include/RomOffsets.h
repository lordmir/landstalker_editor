...
namespace RomOffsets
{
	...
	inline const std::unordered_map<std::string, std::unordered_map<Region, Section>> SECTION
	{
		...
		{ Strings::HUFFMAN_SECTION,                {{Region::JP, {0x023834, 0x025562}}, {Region::US, {0x023900, 0x02469C}}, {Region::UK, {0x023900, 0x02469C}}, {Region::FR, {0x023BF6, 0x024732}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
