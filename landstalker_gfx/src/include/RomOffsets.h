...
namespace RomOffsets
{
	...
	inline const std::unordered_map<std::string, std::unordered_map<Region, uint32_t>> ADDRESS
	{
		...
		{ Sprites::ONE_TIME_EVENT_FLAGS,         {{Region::JP, 0x000000}, {Region::US, 0x01A3D8}, {Region::UK, 0x000000}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}}},
		...
		{ Sprites::PALETTE_HI_DATA,              {{Region::JP, 0x000000}, {Region::US, 0x1A44AE}, {Region::UK, 0x000000}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}}},
		{ Sprites::PALETTE_LO_DATA,              {{Region::JP, 0x000000}, {Region::US, 0x1A4498}, {Region::UK, 0x000000}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}}},
	...
	inline const std::unordered_map<std::string, std::unordered_map<Region, Section>> SECTION
	{
		...
		{ Sprites::PALETTE_DATA,                 {{Region::JP, {0x000000, 0x000000}}, {Region::US, {0x1A453A, 0x1A4C8E}}, {Region::UK, {0x000000, 0x000000}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
