    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_menuItem110 = new wxMenuItem(m_name6, wxID_ANY, _("Export to PNG\tCtrl+E"), wxT(""), wxITEM_NORMAL);
    m_name6->Append(m_menuItem110);
    ...
    m_auimgr127->SetFlags(wxAUI_MGR_LIVE_RESIZE | wxAUI_MGR_TRANSPARENT_HINT | wxAUI_MGR_TRANSPARENT_DRAG |
    ...
    m_panel134 = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTAB_TRAVERSAL);

    m_auimgr127->AddPane(m_panel134,
        wxAuiPaneInfo()
            .Caption(_("Browser"))
    ...
    m_treeCtrl101 = new wxTreeCtrl(m_panel134, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel134, wxSize(300, 50)),
        wxTR_DEFAULT_STYLE | wxTR_HIDE_ROOT | wxFULL_REPAINT_ON_RESIZE);

    boxSizer138->Add(m_treeCtrl101, 1, wxALL | wxEXPAND, WXC_FROM_DIP(5));
    m_treeCtrl101->SetMinSize(wxSize(300, 50));

    m_panel136 = new wxPanel(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)), wxTAB_TRAVERSAL);

    m_auimgr127->AddPane(m_panel136,
        wxAuiPaneInfo()
    ...
    m_pgMgr146 =
        new wxPropertyGridManager(m_panel136, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel136, wxSize(300, 50)),
            wxPG_DESCRIPTION | wxPG_LIMITED_EDITING | wxPG_BOLD_MODIFIED | wxPG_AUTO_SORT);

    boxSizer144->Add(m_pgMgr146, 1, wxALL | wxEXPAND, WXC_FROM_DIP(5));
    m_pgMgr146->SetMinSize(wxSize(300, 50));

    m_scrollWin27 = new wxScrolledWindow(this, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(this, wxSize(-1, -1)),
    ...
    m_auimgr127->AddPane(m_scrollWin27,
        wxAuiPaneInfo()
...
#endif
    // Connect events
    this->Connect(m_menuItem109->GetId(), wxEVT_COMMAND_MENU_SELECTED,
        wxCommandEventHandler(MainFrameBaseClass::OnMenuitem109MenuSelected), NULL, this);
    this->Connect(m_menuItem110->GetId(), wxEVT_COMMAND_MENU_SELECTED,
        wxCommandEventHandler(MainFrameBaseClass::OnMenuitem110MenuSelected), NULL, this);
    ...
    this->Connect(m_menuItem9->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler(MainFrameBaseClass::OnAbout),
        NULL, this);
    m_treeCtrl101->Connect(wxEVT_COMMAND_TREE_ITEM_ACTIVATED,
        wxTreeEventHandler(MainFrameBaseClass::OnTreectrl101TreeItemActivated), NULL, this);
    m_scrollWin27->Connect(wxEVT_PAINT, wxPaintEventHandler(MainFrameBaseClass::OnScrollwin27Paint), NULL, this);
}

MainFrameBaseClass::~MainFrameBaseClass()
{
    this->Disconnect(m_menuItem109->GetId(), wxEVT_COMMAND_MENU_SELECTED,
        wxCommandEventHandler(MainFrameBaseClass::OnMenuitem109MenuSelected), NULL, this);
    this->Disconnect(m_menuItem110->GetId(), wxEVT_COMMAND_MENU_SELECTED,
        wxCommandEventHandler(MainFrameBaseClass::OnMenuitem110MenuSelected), NULL, this);
    ...
    m_treeCtrl101->Disconnect(wxEVT_COMMAND_TREE_ITEM_ACTIVATED,
        wxTreeEventHandler(MainFrameBaseClass::OnTreectrl101TreeItemActivated), NULL, this);
    ...
    , m_imagesHeight(16)
{
...

    {
        wxBitmap bmp;
        wxIcon icn;
        bmp = wxXmlResource::Get()->LoadBitmap(wxT("m_bmp154"));
        if(bmp.IsOk()) {
            if((m_imagesWidth == bmp.GetWidth()) && (m_imagesHeight == bmp.GetHeight())) {
                icn.CopyFromBitmap(bmp);
                this->Add(icn);
            }
            m_bitmaps.insert(std::make_pair(wxT("m_bmp154"), bmp));
        }
    }
}
