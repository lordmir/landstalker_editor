...
void wxC9ED9InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/wxcrafter_bitmaps.cpp$C__Users_Tom_Documents_GitHub_landstalker_gfx_landstalker_gfx_wxcrafter_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/wxcrafter_bitmaps.cpp$C__Users_Tom_Documents_GitHub_landstalker_gfx_landstalker_gfx_wxcrafter_bitmaps.xrc"));
}
