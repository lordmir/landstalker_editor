...
namespace RomLabels
{
	namespace Sprites
	{
		...
		const std::string UNKNOWN_SPRITE_LOOKUP("UnknownSpriteLookup_1");
		const std::string UNKNOWN_SPRITE_LOOKUP_SECTION("UnknownSpriteLookup_1Section");
		...
		const std::string UNKNOWN_SPRITE_LOOKUP_FILE("assets_packed/spritedata/spritetable6F.bin");
