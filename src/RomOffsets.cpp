...
namespace RomOffsets
{
	...
	const std::unordered_map<std::string, std::unordered_map<Region, uint32_t>> ADDRESS
	{
		...
		{ Rooms::DOOR_OFFSET_TABLE,                {{Region::JP, 0x0095B8}, {Region::US, 0x00961E}, {Region::UK, 0x00961E}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::DOOR_TABLE,                       {{Region::JP, 0x0095D8}, {Region::US, 0x00963E}, {Region::UK, 0x00963E}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::GFX_SWAP_FLAGS,                   {{Region::JP, 0x004DE2}, {Region::US, 0x004DFC}, {Region::UK, 0x004DFC}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::GFX_SWAP_LOCKED_DOOR_FLAGS_LEA1,  {{Region::JP, 0x004DEE}, {Region::US, 0x004E08}, {Region::UK, 0x004E08}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::GFX_SWAP_LOCKED_DOOR_FLAGS_LEA2,  {{Region::JP, 0x004F92}, {Region::US, 0x004FAC}, {Region::UK, 0x004FAC}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::GFX_SWAP_TREE_FLAGS,              {{Region::JP, 0x004E2C}, {Region::US, 0x004E46}, {Region::UK, 0x004E46}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::GFX_SWAP_TABLE,                   {{Region::JP, 0x004EB0}, {Region::US, 0x004ECA}, {Region::UK, 0x004ECA}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::BIG_TREE_LOCATIONS,               {{Region::JP, 0x01A01A}, {Region::US, 0x01A03E}, {Region::UK, 0x01A03E}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::SHOP_LIST_LEA1,                   {{Region::JP, 0x009B7E}, {Region::US, 0x009BE4}, {Region::UK, 0x009BE4}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::SHOP_LIST_LEA2,                   {{Region::JP, 0x009BAC}, {Region::US, 0x009C12}, {Region::UK, 0x009C12}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::LIFESTOCK_SOLD_FLAGS,             {{Region::JP, 0x009C70}, {Region::US, 0x009CD6}, {Region::UK, 0x009CD6}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}} },
		{ Rooms::LANTERN_ROOM_FLAGS,               {{Region::JP, 0x008764}, {Region::US, 0x0087BE}, {Region::UK, 0x0087BE}, {Region::FR, 0x000000}, {Region::DE, 0x000000}, {Region::US_BETA, 0x000000}}},
	...
	const std::unordered_map<std::string, std::unordered_map<Region, Section>> SECTION
	{
		...
		{ Rooms::DOOR_TABLE_SECTION,               {{Region::JP, {0x009706, 0x009B64}}, {Region::US, {0x00976C, 0x009BCA}}, {Region::UK, {0x00976C, 0x009BE4}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
		{ Rooms::GFX_SWAP_SECTION,                 {{Region::JP, {0x004FD0, 0x00600E}}, {Region::US, {0x004FEA, 0x00603C}}, {Region::UK, {0x004FEA, 0x00603C}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
		{ Rooms::BIG_TREE_LOCATIONS_SECTION,       {{Region::JP, {0x01A034, 0x01A048}}, {Region::US, {0x01A058, 0x01A06C}}, {Region::UK, {0x01A058, 0x01A06C}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
		{ Rooms::SHOP_LIST_SECTION,                {{Region::JP, {0x009BDC, 0x009C1C}}, {Region::US, {0x009C42, 0x009C82}}, {Region::UK, {0x009C42, 0x009C82}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
		{ Rooms::LIFESTOCK_SOLD_FLAGS_SECTION,     {{Region::JP, {0x009CB2, 0x009CD0}}, {Region::US, {0x009D18, 0x009D36}}, {Region::UK, {0x009D18, 0x009D36}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
		{ Rooms::LANTERN_ROOM_FLAGS_SECTION,       {{Region::JP, {0x0087A6, 0x0087D8}}, {Region::US, {0x008800, 0x008832}}, {Region::UK, {0x008800, 0x008832}}, {Region::FR, {0x000000, 0x000000}}, {Region::DE, {0x000000, 0x000000}}, {Region::US_BETA, {0x000000, 0x000000}}}},
