...
void RoomViewerFrame::ShowTileswapDialog(bool force, TileSwapDialog::PageType page)
{
...
{
	ShowTileswapDialog(true, TileSwapDialog::PageType::SWAPS);
}
...
{
	ShowTileswapDialog(true, TileSwapDialog::PageType::DOORS);
}
