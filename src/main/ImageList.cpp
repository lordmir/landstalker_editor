	...
	: wxImageList(img32x32 ? 32 : 16, img32x32 ? 32 : 16, true)
{
	...
	else
	{
		...
		m_images["bigtiles"] = wxBITMAP_PNG_FROM_DATA(bigtiles_16x16);
		...
		m_images["datatable"] = wxBITMAP_PNG_FROM_DATA(datatable_16x16);
		m_images["delete"] = wxBITMAP_PNG_FROM_DATA(DELETE_16x16);
		m_images["delete_col"] = wxBITMAP_PNG_FROM_DATA(delete_col_16x16);
		m_images["delete_nwse"] = wxBITMAP_PNG_FROM_DATA(delete_nwse_16x16);
		...
		m_images["fill"] = wxBITMAP_PNG_FROM_DATA(fill_16x16);
		...
		m_images["img"] = wxBITMAP_PNG_FROM_DATA(img_16x16);
		...
		m_images["insert_col_after"] = wxBITMAP_PNG_FROM_DATA(insert_col_after_16x16);
		m_images["insert_col_before"] = wxBITMAP_PNG_FROM_DATA(insert_col_before_16x16);
		...
		m_images["prop"] = wxBITMAP_PNG_FROM_DATA(PROP_16x16);
		m_images["rect_filled"] = wxBITMAP_PNG_FROM_DATA(rect_filled_16x16);
		m_images["rect_outline"] = wxBITMAP_PNG_FROM_DATA(rect_outline_16x16);
		...
		m_images["tilenums"] = wxBITMAP_PNG_FROM_DATA(tilenums_16x16);
		m_images["ts"] = wxBITMAP_PNG_FROM_DATA(ts_16x16);
