...
DataViewCtrlPaletteModel::DataViewCtrlPaletteModel(const std::vector<std::shared_ptr<Landstalker::PaletteEntry>>& palettes, const std::vector<std::wstring>& labels)
