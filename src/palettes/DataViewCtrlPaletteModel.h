...
public:
    ...
    DataViewCtrlPaletteModel(const std::vector<std::shared_ptr<Landstalker::PaletteEntry>>& palettes, const std::vector<std::wstring>& labels);
...
private:
    std::vector<std::shared_ptr<Landstalker::PaletteEntry>> m_palettes;
