...
void SubspriteControlFrame::SetSubsprites(const std::vector<Landstalker::SpriteFrame::SubSprite>& subsprites)
{
...
{
	return Landstalker::StrWPrintf(L"%02d: (%02d, %02d) %01dx%01d @%02d", index + 1, m_subsprites[index].x,
