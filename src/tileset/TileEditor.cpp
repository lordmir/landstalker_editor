...
void TileEditor::SetGameData(std::shared_ptr<Landstalker::GameData> gd)
{
	m_gd = gd;
	if (m_gd == nullptr)
	{
...
void TileEditor::SetTileset(std::shared_ptr<Landstalker::Tileset> tileset)
{
	m_tileset = tileset;
...
void TileEditor::SetTile(const Landstalker::Tile& tile)
{
	m_tile = tile;
...
void TileEditor::SetActivePalette(std::shared_ptr<Landstalker::Palette> pal)
{
	m_selected_palette_name = "";
	m_selected_palette_entry = nullptr;
...
const Landstalker::Tile& TileEditor::GetTile() const
{
	return m_tile;
}
